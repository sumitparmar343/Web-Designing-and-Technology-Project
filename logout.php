...
# echo "You successfully logout. click here to <a href='login.php'>login agian</a>";
?>
...
<body onload="document.registration.userid.focus();" class="game_info" data-spy="scroll" data-target=".header">
    ...
    <div class="container">
        <h1>Welcome to Mumbai Indians login Box</h3>
            ...
            <form action="login.php" method="post">
                ...
                <label style="margin-left: -63% !important;
                margin-top: -21px;">Remember me</label><br>
    ...
    <footer id="footer" class="footer">
                    ...
                    <div class="full">
                        <div class="footer-widget">
                            ...
                            <ul class="address-list">
                                <li><i class="fa fa-map-marker"></i>Vinoo Mankad Rd, Churchgate, Mumbai, Maharashtra 400020</li>
                                <li><i class="fa fa-phone"></i>1800 889 8989</li>
                                <li><i style="font-size:20px;top:5px;" class="fa fa-envelope"></i> info@mumbaiindians.com</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="full">
                        <div class="contact-footer">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d120615.72236587871!2d73.07890527988283!3d19.140910987164396!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1527759905404" width="600" height="350" frameborder="0" style="border:0"
        ...
        <div class="footer-bottom">
            <div class="container">
                <p>Copyright © 2021 Mumbai Indians.All rights reserved.</p>
            </div>
        </div>
    </footer>
